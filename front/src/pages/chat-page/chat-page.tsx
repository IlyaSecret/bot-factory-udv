        ...
        <div className="chat-page">
            ...
            <div className='chat-page__users-info'>
                ...
                <div className='chat-page__users'>
                    {currentChatUsers?.map(user => <EmployeeItem employee={user} key={user.id} withAdditional={true} withTags={false}></EmployeeItem>)}
                </div>
            </div>
            ...
            <Modal active={isActiveSecond} setActive={setActiveSecond}>
                <div className='delete-employee'>
                    <h3>Вы уверенны, что хотите удалить { currentChat?.name }?</h3>
